...
class Export:
    ...
    def __init__(self, object_type, changelog_timestamp, limit):
        if object_type == 'person':
            self.name = 'ETL Process Person [Samples]'
            self.tags = [88]
            ...
            self.name = 'ETL Process Group [Samples]'
            self.tags = [89, 90]
            self.objecttypes = ['act_grpm_0103']
            self.pool_fields = ['act_grpm_0103._pool.pool._id']
            self.pool_ids = [124]
            ...
            self.name = 'ETL Process Architectural Competition [Samples]'
            self.tags = [210]
            self.objecttypes = ['ac']
            ...
            self.name = 'ETL Process Archival Unit [Samples]'
            ...
            self.name = 'ETL Process Bibliographic Item [Samples]'
            self.tags = None
            ...
            self.name = 'ETL Process Digital Object [Samples]'
            self.tags = None
            ...
            self.name = 'ETL Process Œuvre [Samples]'
            self.tags = [91]
            ...
            self.name = 'ETL Process Built Work [Samples]'
            self.tags = [92]
            self.objecttypes = ['oeu']
            self.pool_fields = ['oeu._pool.pool._id']
            self.pool_ids = [119]
            ...
            self.name = 'ETL Process Architectural Project [Samples]'
            self.tags = [93]
            self.objecttypes = ['oeu']
            self.pool_fields = ['oeu._pool.pool._id']
            self.pool_ids = [119]
            ...
            self.name = 'ETL Process Place [Samples]'
            self.tags = None
